...
//    c)void SetGDP - встановлення для відповідного приватного поля валового доходу
// на 1го працівника - сума вартості всіх товарів / на кількість працівників 
...
//7.Змінити поле “Ім”я “ для департаменту на readonly, яке повинне ініці
